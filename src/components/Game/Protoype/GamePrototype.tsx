...
import { ShipTemplate, setShips, setAiDifficulty } from "../../reducer/TestReducer";
import smallShip from "../../../assets/pictures/Schiffe/StandardPNG/2.png";
import mediumShip from "../../../assets/pictures/Schiffe/StandardPNG/3.png";
import largeShip from "../../../assets/pictures/Schiffe/StandardPNG/4.png";
import xlargeShip from "../../../assets/pictures/Schiffe/StandardPNG/5.png";
import smallShipR from "../../../assets/pictures/Schiffe/StandardPNG/2r.png";
import mediumShipR from "../../../assets/pictures/Schiffe/StandardPNG/3r.png";
...
// TODO
// Schiffe drehen image richtig machen
// Schiff symbole zum ziehen
// Button größe ordentlich
// daten weiterleiten
// roter Rahmen verschwindet bei onDrop und beim drehen
const space = 0;
...
export default function GamePrototype2() {
  ...
  const onDragStop = (layout: any, oldItemIndex: any, newItem: Layout) => {
    ...
    // wenn ich das wegmache verschwinden die schatten aber ohne kann ich außerhalb platziern
    // unique machen damit es nicht wiederholt drin steht
    // jetzt geht die collision wieder nicht richtig
    setLayout(updatedLayout);
  ...
  function sendShips(event: any): void {
    ...
    console.log(newItems, " self placed ships")
    dispatch(
      setShips({
        ships: newItems,
      })
  ...
  return (
    <Container className={styles.container}>
      <div className={styles.LogoDiv}>
        {/* <Image draggable={false} className={styles.Logo} src={logoPic} /> */}
      </div>
      <Button onClick={sendDebugShips}>Debug Ships</Button>
